...
class RequiredEmployeesUpdateWorksRequest(TypedDict):
    pass

class OptionalEmployeesUpdateWorksRequest(TypedDict, total=False):
...
class EmployeesUpdateWorksRequest(RequiredEmployeesUpdateWorksRequest, OptionalEmployeesUpdateWorksRequest):
    pass
