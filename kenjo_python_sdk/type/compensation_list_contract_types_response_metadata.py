...
class RequiredCompensationListContractTypesResponseMetadata(TypedDict):
    pass

class OptionalCompensationListContractTypesResponseMetadata(TypedDict, total=False):
...
class CompensationListContractTypesResponseMetadata(RequiredCompensationListContractTypesResponseMetadata, OptionalCompensationListContractTypesResponseMetadata):
    pass
