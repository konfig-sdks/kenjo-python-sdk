...
class RequiredAttendanceGetExpectedTimeByUserResponseMetadata(TypedDict):
    pass

class OptionalAttendanceGetExpectedTimeByUserResponseMetadata(TypedDict, total=False):
...
class AttendanceGetExpectedTimeByUserResponseMetadata(RequiredAttendanceGetExpectedTimeByUserResponseMetadata, OptionalAttendanceGetExpectedTimeByUserResponseMetadata):
    pass
