...
class RequiredEmployeesUpdateWorkScheduleRequest(TypedDict):
    pass

class OptionalEmployeesUpdateWorkScheduleRequest(TypedDict, total=False):
...
class EmployeesUpdateWorkScheduleRequest(RequiredEmployeesUpdateWorkScheduleRequest, OptionalEmployeesUpdateWorkScheduleRequest):
    pass
