...
class RequiredCompensationGetSalariesListResponseMetadata(TypedDict):
    pass

class OptionalCompensationGetSalariesListResponseMetadata(TypedDict, total=False):
...
class CompensationGetSalariesListResponseMetadata(RequiredCompensationGetSalariesListResponseMetadata, OptionalCompensationGetSalariesListResponseMetadata):
    pass
