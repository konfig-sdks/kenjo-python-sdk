...
class RequiredEmployeesListPersonalsResponseDataItem(TypedDict):
    pass

class OptionalEmployeesListPersonalsResponseDataItem(TypedDict, total=False):
...
class EmployeesListPersonalsResponseDataItem(RequiredEmployeesListPersonalsResponseDataItem, OptionalEmployeesListPersonalsResponseDataItem):
    pass
