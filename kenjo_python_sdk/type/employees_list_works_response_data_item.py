...
class RequiredEmployeesListWorksResponseDataItem(TypedDict):
    pass

class OptionalEmployeesListWorksResponseDataItem(TypedDict, total=False):
...
class EmployeesListWorksResponseDataItem(RequiredEmployeesListWorksResponseDataItem, OptionalEmployeesListWorksResponseDataItem):
    pass
