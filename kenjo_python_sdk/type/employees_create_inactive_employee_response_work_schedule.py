...
class RequiredEmployeesCreateInactiveEmployeeResponseWorkSchedule(TypedDict):
    pass

class OptionalEmployeesCreateInactiveEmployeeResponseWorkSchedule(TypedDict, total=False):
...
class EmployeesCreateInactiveEmployeeResponseWorkSchedule(RequiredEmployeesCreateInactiveEmployeeResponseWorkSchedule, OptionalEmployeesCreateInactiveEmployeeResponseWorkSchedule):
    pass
