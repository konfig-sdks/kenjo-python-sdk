...
class RequiredEmployeesListHomesResponseDataItem(TypedDict):
    pass

class OptionalEmployeesListHomesResponseDataItem(TypedDict, total=False):
...
class EmployeesListHomesResponseDataItem(RequiredEmployeesListHomesResponseDataItem, OptionalEmployeesListHomesResponseDataItem):
    pass
