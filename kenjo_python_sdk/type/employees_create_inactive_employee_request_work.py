...
class RequiredEmployeesCreateInactiveEmployeeRequestWork(TypedDict):
...
class OptionalEmployeesCreateInactiveEmployeeRequestWork(TypedDict, total=False):
...
class EmployeesCreateInactiveEmployeeRequestWork(RequiredEmployeesCreateInactiveEmployeeRequestWork, OptionalEmployeesCreateInactiveEmployeeRequestWork):
    pass
