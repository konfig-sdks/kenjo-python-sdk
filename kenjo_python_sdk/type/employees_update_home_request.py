...
class RequiredEmployeesUpdateHomeRequest(TypedDict):
    pass

class OptionalEmployeesUpdateHomeRequest(TypedDict, total=False):
...
class EmployeesUpdateHomeRequest(RequiredEmployeesUpdateHomeRequest, OptionalEmployeesUpdateHomeRequest):
    pass
