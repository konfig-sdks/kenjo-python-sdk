...
class RequiredEmployeesUpdateHomeResponse(TypedDict):
    pass

class OptionalEmployeesUpdateHomeResponse(TypedDict, total=False):
...
class EmployeesUpdateHomeResponse(RequiredEmployeesUpdateHomeResponse, OptionalEmployeesUpdateHomeResponse):
    pass
