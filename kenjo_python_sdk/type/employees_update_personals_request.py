...
class RequiredEmployeesUpdatePersonalsRequest(TypedDict):
    pass

class OptionalEmployeesUpdatePersonalsRequest(TypedDict, total=False):
...
class EmployeesUpdatePersonalsRequest(RequiredEmployeesUpdatePersonalsRequest, OptionalEmployeesUpdatePersonalsRequest):
    pass
