...
class RequiredTimeOffGetRequestsByDateResponseMetadata(TypedDict):
    pass

class OptionalTimeOffGetRequestsByDateResponseMetadata(TypedDict, total=False):
...
class TimeOffGetRequestsByDateResponseMetadata(RequiredTimeOffGetRequestsByDateResponseMetadata, OptionalTimeOffGetRequestsByDateResponseMetadata):
    pass
