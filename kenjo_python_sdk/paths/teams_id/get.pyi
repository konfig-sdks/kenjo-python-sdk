...
from kenjo_python_sdk.model.teams_get_by_id_response import TeamsGetByIdResponse as TeamsGetByIdResponseSchema
...
from kenjo_python_sdk.type.teams_get_by_id_response import TeamsGetByIdResponse

from ...api_client import Dictionary
from kenjo_python_sdk.pydantic.teams_get_by_id_response import TeamsGetByIdResponse as TeamsGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TeamsGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TeamsGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return TeamsGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TeamsGetByIdResponsePydantic, raw_response.body)
