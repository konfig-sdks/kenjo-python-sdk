...
from kenjo_python_sdk.model.employees_update_home_response import EmployeesUpdateHomeResponse as EmployeesUpdateHomeResponseSchema
from kenjo_python_sdk.model.employees_update_home_request import EmployeesUpdateHomeRequest as EmployeesUpdateHomeRequestSchema
...
from kenjo_python_sdk.type.employees_update_home_response import EmployeesUpdateHomeResponse
from kenjo_python_sdk.type.employees_update_home_request import EmployeesUpdateHomeRequest
...
from kenjo_python_sdk.pydantic.employees_update_home_request import EmployeesUpdateHomeRequest as EmployeesUpdateHomeRequestPydantic
from kenjo_python_sdk.pydantic.employees_update_home_response import EmployeesUpdateHomeResponse as EmployeesUpdateHomeResponsePydantic
...
# body param
SchemaForRequestBodyApplicationJson = EmployeesUpdateHomeRequestSchema


request_body_employees_update_home_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = EmployeesUpdateHomeResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeesUpdateHomeResponse
    ...
    async def _aupdate_home_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/employees/{employeeId}/homes',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_employees_update_home_request.serialize(body, content_type)
...
class UpdateHomeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_home(
        self,
        employee_id: str,
        authorization: str,
        marital_status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_home_mapped_args(
        ...
        return await self._aupdate_home_oapg(
            body=args.body,
    ...
    def update_home(
        ...
        return self._update_home_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateHome(BaseApi):
    ...
    async def aupdate_home(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeesUpdateHomeResponsePydantic:
        raw_response = await self.raw.aupdate_home(
            employee_id=employee_id,
            authorization=authorization,
            marital_status=marital_status,
            spouse_first_name=spouse_first_name,
        ...
        if validate:
            return EmployeesUpdateHomeResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeesUpdateHomeResponsePydantic, raw_response.body)
    ...
    def update_home(
        ...
        raw_response = self.raw.update_home(
            employee_id=employee_id,
            authorization=authorization,
            marital_status=marital_status,
            spouse_first_name=spouse_first_name,
