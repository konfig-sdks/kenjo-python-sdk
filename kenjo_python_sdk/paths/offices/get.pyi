...
from kenjo_python_sdk.model.offices_get_list_response import OfficesGetListResponse as OfficesGetListResponseSchema
...
from kenjo_python_sdk.type.offices_get_list_response import OfficesGetListResponse

from ...api_client import Dictionary
from kenjo_python_sdk.pydantic.offices_get_list_response import OfficesGetListResponse as OfficesGetListResponsePydantic
...
CalendarIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'calendarId': typing.Union[CalendarIdSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = OfficesGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OfficesGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OfficesGetListResponsePydantic:
        ...
        if validate:
            return RootModel[OfficesGetListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(OfficesGetListResponsePydantic, raw_response.body)
