...
from kenjo_python_sdk.model.employees_get_accounts_response import EmployeesGetAccountsResponse as EmployeesGetAccountsResponseSchema
...
from kenjo_python_sdk.type.employees_get_accounts_response import EmployeesGetAccountsResponse
...
from kenjo_python_sdk.pydantic.employees_get_accounts_response import EmployeesGetAccountsResponse as EmployeesGetAccountsResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'externalId': typing.Union[ExternalIdSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = EmployeesGetAccountsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeesGetAccountsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_accounts_mapped_args(
        ...
        if external_id is not None:
            _query_params["externalId"] = external_id
    ...
    async def _aget_accounts_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/employees/accounts',
            headers=_headers,
        )
...
class GetAccounts(BaseApi):
    ...
    async def aget_accounts(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeesGetAccountsResponsePydantic:
        ...
        if validate:
            return EmployeesGetAccountsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeesGetAccountsResponsePydantic, raw_response.body)
