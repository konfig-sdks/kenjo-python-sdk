...
from kenjo_python_sdk.model.employees_list_personals_response import EmployeesListPersonalsResponse as EmployeesListPersonalsResponseSchema
...
from kenjo_python_sdk.type.employees_list_personals_response import EmployeesListPersonalsResponse
...
from kenjo_python_sdk.pydantic.employees_list_personals_response import EmployeesListPersonalsResponse as EmployeesListPersonalsResponsePydantic
...
class GenderSchema(
    ...
    def OTHER(cls):
        return cls("Other")
BirthdateSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'birthdate': typing.Union[BirthdateSchema, str, ],
    },
    total=False
)
...
request_query_birthdate = api_client.QueryParameter(
    name="birthdate",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = EmployeesListPersonalsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeesListPersonalsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_personals_mapped_args(
        self,
        authorization: str,
        ...
        if display_name is not None:
            _query_params["displayName"] = display_name
        if gender is not None:
            _query_params["gender"] = gender
        if birthdate is not None:
            _query_params["birthdate"] = birthdate
    ...
    async def _alist_personals_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/employees/personals',
            headers=_headers,
        )
...
class ListPersonalsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_personals(
        self,
        authorization: str,
        first_name: typing.Optional[str] = None,
        last_name: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_personals_mapped_args(
        ...
        return await self._alist_personals_oapg(
    ...
    def list_personals(
        ...
        return self._list_personals_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class ListPersonals(BaseApi):
    ...
    async def alist_personals(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeesListPersonalsResponsePydantic:
        raw_response = await self.raw.alist_personals(
            authorization=authorization,
            first_name=first_name,
            last_name=last_name,
            display_name=display_name,
        ...
        if validate:
            return EmployeesListPersonalsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeesListPersonalsResponsePydantic, raw_response.body)
    ...
    def list_personals(
        ...
        raw_response = self.raw.list_personals(
            authorization=authorization,
            first_name=first_name,
            last_name=last_name,
            display_name=display_name,
