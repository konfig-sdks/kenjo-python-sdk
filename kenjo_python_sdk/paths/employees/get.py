...
from kenjo_python_sdk.model.employees_get_list_response import EmployeesGetListResponse as EmployeesGetListResponseSchema
...
from kenjo_python_sdk.type.employees_get_list_response import EmployeesGetListResponse
...
from kenjo_python_sdk.pydantic.employees_get_list_response import EmployeesGetListResponse as EmployeesGetListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeesGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeesGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeesGetListResponsePydantic:
        raw_response = await self.raw.aget_list(
            authorization=authorization,
            **kwargs,
        )
        if validate:
            return EmployeesGetListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeesGetListResponsePydantic, raw_response.body)
