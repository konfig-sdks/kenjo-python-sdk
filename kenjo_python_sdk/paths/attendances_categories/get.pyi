...
from kenjo_python_sdk.model.attendance_get_categories_response import AttendanceGetCategoriesResponse as AttendanceGetCategoriesResponseSchema
...
from kenjo_python_sdk.type.attendance_get_categories_response import AttendanceGetCategoriesResponse
...
from kenjo_python_sdk.pydantic.attendance_get_categories_response import AttendanceGetCategoriesResponse as AttendanceGetCategoriesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AttendanceGetCategoriesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AttendanceGetCategoriesResponse
    ...
    async def _aget_categories_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/attendances/categories',
            headers=_headers,
        )
...
class GetCategories(BaseApi):
    ...
    async def aget_categories(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AttendanceGetCategoriesResponsePydantic:
        raw_response = await self.raw.aget_categories(
            authorization=authorization,
            **kwargs,
        )
        if validate:
            return AttendanceGetCategoriesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AttendanceGetCategoriesResponsePydantic, raw_response.body)
