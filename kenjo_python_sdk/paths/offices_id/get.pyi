...
from kenjo_python_sdk.model.offices_get_by_id_response import OfficesGetByIdResponse as OfficesGetByIdResponseSchema
...
from kenjo_python_sdk.type.offices_get_by_id_response import OfficesGetByIdResponse

from ...api_client import Dictionary
from kenjo_python_sdk.pydantic.offices_get_by_id_response import OfficesGetByIdResponse as OfficesGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OfficesGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OfficesGetByIdResponse
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> OfficesGetByIdResponsePydantic:
        ...
        if validate:
            return OfficesGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OfficesGetByIdResponsePydantic, raw_response.body)
