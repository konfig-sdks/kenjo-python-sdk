...
from kenjo_python_sdk.model.companies_get_list_response import CompaniesGetListResponse as CompaniesGetListResponseSchema
...
from kenjo_python_sdk.type.companies_get_list_response import CompaniesGetListResponse
...
from kenjo_python_sdk.pydantic.companies_get_list_response import CompaniesGetListResponse as CompaniesGetListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CompaniesGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CompaniesGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CompaniesGetListResponsePydantic:
        ...
        if validate:
            return RootModel[CompaniesGetListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CompaniesGetListResponsePydantic, raw_response.body)
