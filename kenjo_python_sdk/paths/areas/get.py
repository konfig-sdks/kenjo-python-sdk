...
from kenjo_python_sdk.model.areas_get_list_response import AreasGetListResponse as AreasGetListResponseSchema
...
from kenjo_python_sdk.type.areas_get_list_response import AreasGetListResponse
...
from kenjo_python_sdk.pydantic.areas_get_list_response import AreasGetListResponse as AreasGetListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AreasGetListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AreasGetListResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AreasGetListResponsePydantic:
        raw_response = await self.raw.aget_list(
            authorization=authorization,
            **kwargs,
        )
        if validate:
            return RootModel[AreasGetListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(AreasGetListResponsePydantic, raw_response.body)
