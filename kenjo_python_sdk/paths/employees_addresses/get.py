...
from kenjo_python_sdk.model.employees_list_addresses_response import EmployeesListAddressesResponse as EmployeesListAddressesResponseSchema
...
from kenjo_python_sdk.type.employees_list_addresses_response import EmployeesListAddressesResponse
...
from kenjo_python_sdk.pydantic.employees_list_addresses_response import EmployeesListAddressesResponse as EmployeesListAddressesResponsePydantic
...
# Query params
StreetSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'street': typing.Union[StreetSchema, str, ],
...
request_query_street = api_client.QueryParameter(
    name="street",
...
SchemaFor200ResponseBodyApplicationJson = EmployeesListAddressesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EmployeesListAddressesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_addresses_mapped_args(
        self,
        authorization: str,
    ...
    async def _alist_addresses_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/employees/addresses',
            headers=_headers,
        )
...
class ListAddressesRaw(BaseApi):
    ...
    async def alist_addresses(
        ...
        **kwargs,
        ...
        args = self._list_addresses_mapped_args(
        ...
        return await self._alist_addresses_oapg(
...
class ListAddresses(BaseApi):
    ...
    async def alist_addresses(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeesListAddressesResponsePydantic:
        raw_response = await self.raw.alist_addresses(
            authorization=authorization,
            street=street,
            postal_code=postal_code,
            city=city,
        ...
        if validate:
            return EmployeesListAddressesResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeesListAddressesResponsePydantic, raw_response.body)
    ...
    def list_addresses(
        ...
        raw_response = self.raw.list_addresses(
            authorization=authorization,
            street=street,
            postal_code=postal_code,
            city=city,
