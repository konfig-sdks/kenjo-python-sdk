...
from kenjo_python_sdk.model.attendance_get_expected_time_by_user_response import AttendanceGetExpectedTimeByUserResponse as AttendanceGetExpectedTimeByUserResponseSchema
...
from kenjo_python_sdk.type.attendance_get_expected_time_by_user_response import AttendanceGetExpectedTimeByUserResponse

from ...api_client import Dictionary
from kenjo_python_sdk.pydantic.attendance_get_expected_time_by_user_response import AttendanceGetExpectedTimeByUserResponse as AttendanceGetExpectedTimeByUserResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AttendanceGetExpectedTimeByUserResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AttendanceGetExpectedTimeByUserResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_expected_time_by_user_mapped_args(
        self,
        _from: str,
        to: str,
        authorization: str,
    ...
    async def _aget_expected_time_by_user_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/attendances/expected-time',
            headers=_headers,
        )
    ...
    def _get_expected_time_by_user_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetExpectedTimeByUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_expected_time_by_user(
        self,
        _from: str,
        to: str,
        authorization: str,
        ...
        **kwargs,
        ...
        args = self._get_expected_time_by_user_mapped_args(
            _from=_from,
            to=to,
        ...
        return await self._aget_expected_time_by_user_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def get_expected_time_by_user(
        self,
        _from: str,
        to: str,
        authorization: str,
        ...
        return self._get_expected_time_by_user_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetExpectedTimeByUser(BaseApi):
    ...
    async def aget_expected_time_by_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AttendanceGetExpectedTimeByUserResponsePydantic:
        raw_response = await self.raw.aget_expected_time_by_user(
            _from=_from,
            to=to,
            authorization=authorization,
            company_id=company_id,
        ...
        if validate:
            return AttendanceGetExpectedTimeByUserResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AttendanceGetExpectedTimeByUserResponsePydantic, raw_response.body)
    ...
    def get_expected_time_by_user(
        ...
        raw_response = self.raw.get_expected_time_by_user(
            _from=_from,
            to=to,
            authorization=authorization,
            company_id=company_id,
