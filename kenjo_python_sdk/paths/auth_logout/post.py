...
class BaseApi(api_client.Api):
    ...
    def _invalidate_token_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _ainvalidate_token_oapg(
        self,
...
class InvalidateTokenRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainvalidate_token(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor204Async,
        ...
        args = self._invalidate_token_mapped_args(
        )
        return await self._ainvalidate_token_oapg(
            **kwargs,
        )
    ...
    def invalidate_token(
        ...
        return self._invalidate_token_oapg(
        )

class InvalidateToken(BaseApi):
    ...
    async def ainvalidate_token(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainvalidate_token(
            **kwargs,
        )
    ...
    def invalidate_token(
        ...
        raw_response = self.raw.invalidate_token(
        )
