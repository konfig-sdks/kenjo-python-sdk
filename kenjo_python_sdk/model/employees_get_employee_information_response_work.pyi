...
class EmployeesGetEmployeeInformationResponseWork(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["companyId", "officeId", "departmentId", "startDate", "jobTitle", "workPhone", "workMobile", "isAssistant", "probationPeriodEnd", "reportsToId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["companyId", "officeId", "departmentId", "startDate", "jobTitle", "workPhone", "workMobile", "isAssistant", "probationPeriodEnd", "reportsToId", ], str]):
