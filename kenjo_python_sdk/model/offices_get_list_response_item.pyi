...
class OfficesGetListResponseItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "name", "companyId", "calendarId", "street", "postalCode", "city", "country", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "name", "companyId", "calendarId", "street", "postalCode", "city", "country", ], str]):
