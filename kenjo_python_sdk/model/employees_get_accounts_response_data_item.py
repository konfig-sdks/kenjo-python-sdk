...
class EmployeesGetAccountsResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "email", "externalId", "language", "isActive", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "email", "externalId", "language", "isActive", ], str]):
    ...
    ) -> 'EmployeesGetAccountsResponseDataItem':
