...
class OfficesCreateNewOfficeResponse(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "name", "companyId", "calendarId", "country", "postalCode", "city", "street", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "name", "companyId", "calendarId", "country", "postalCode", "city", "street", ], str]):
