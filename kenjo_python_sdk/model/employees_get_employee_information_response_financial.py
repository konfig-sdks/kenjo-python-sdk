...
class EmployeesGetEmployeeInformationResponseFinancial(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountHolderName", "bankName", "accountNumber", "iban", "swiftCode", "nationalId", "passport", "nationalInsuranceNumber", "taxCode", "taxIdentificationNumber", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountHolderName", "bankName", "accountNumber", "iban", "swiftCode", "nationalId", "passport", "nationalInsuranceNumber", "taxCode", "taxIdentificationNumber", ], str]):
