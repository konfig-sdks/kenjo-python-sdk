...
class EmployeesListPersonalsResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "firstName", "lastName", "displayName", "gender", "birthdate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "firstName", "lastName", "displayName", "gender", "birthdate", ], str]):
    ...
    ) -> 'EmployeesListPersonalsResponseDataItem':
