...
class CompensationListContractTypesResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["_id", "name", "isActive", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["_id", "name", "isActive", ], str]):
    ...
    ) -> 'CompensationListContractTypesResponseDataItem':
