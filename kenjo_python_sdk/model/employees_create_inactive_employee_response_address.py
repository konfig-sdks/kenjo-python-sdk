...
class EmployeesCreateInactiveEmployeeResponseAddress(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["street", "postalCode", "city", "country", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["street", "postalCode", "city", "country", ], str]):
